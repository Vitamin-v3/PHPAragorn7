<!-- Modal Create-->
<div class="modal fade" tabindex="-1" role="dialog" id="modal_people">
        ...
        <div class="modal-body">
            ...
            <form action="" method="post">
                <div class="form-group">
                    <input type="text" class="form-control mb-2" name="id" value="" placeholder="id">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control mb-2" name="name" value="" placeholder="name">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control mb-2" name="access_num" value="" placeholder="access_num">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal_people">Отмена</button>
    ...
    <div class="modal-content shadow">
        ...
        <div class="modal-body">
          <form action="?id=<?=$value['id'] ?>" method="post">
                <div class="form-group">
                    <input type="text" class="form-control mb-2" name="id" value="<?=$value['id'] ?>" placeholder="id">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control mb-2" name="name" value="<?=$value['name'] ?>" placeholder="name">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control mb-2" name="access_num" value="<?=$value['access_num'] ?>" placeholder="access_num">
                </div>
              	<div class="modal-footer">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content shadow">
      <div class="modal-header">
        ...
        <button type="button" class="close btn" data-dismiss="modal_people" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-footer">
